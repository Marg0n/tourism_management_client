...
const FooterSection = () => {
    return (
        <footer className="footer footer-center p-10  text-base-content bg-slate-500 font-semibold">
            ...
            <aside>
                <p>Contact us: <span className="font-serif"> +880-1789456123</span></p>
                <p>Mail us: <span className="font-serif"> info@horizon.bd.org</span></p>
                <p>Copyright © 2024 - All right reserved by <span className="font-serif">Horizon Tourism Ltd.</span></p>
            </aside>
        </footer>
    );
};
